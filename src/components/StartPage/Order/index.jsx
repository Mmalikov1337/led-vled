...
const GapLine = ({ color, activeColor, currentPath, pathname }) => {
	return <svg width="71" height="6" viewBox="0 0 71 6" fill="none" xmlns="http://www.w3.org/2000/svg" className="order__numbers-container__numbers__gapline">
		<rect x="1" y="2.5" width="70" height="1" rx="0.5" fill={pathname === currentPath ? activeColor : color} />
