...
const LinksList = ({ links, currentPage, setCurrentPage }) => {
	return <ul className="swiper__navbar__list">
		{
			links.map((it, index) => (
...
export default function Swiper({ id, link, setSwiperPage, ChangeQuantity, tempItems }) {
	...
	return (
		<div className="swiper" id={id}>
			<div className={`swiper__background ${heightOfLine ? `${heightOfLine}-bg` : ''}`} style={links[currentPage].style}></div>
					...
					<div className="sidebar-container">
						...
						<div className="swiper__sidebar__progress-line">
							...
							<div className="swiper__sidebar__progress-line__line-holder">
								<div className={`swiper__sidebar__progress-line__line-holder__line ${heightOfLine ? heightOfLine : ''}`}></div>
