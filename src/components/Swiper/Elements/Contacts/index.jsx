							...
							<div>
								...
								<div>
									<svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M6.5 0C3.35 0 0.787109 2.56289 0.787109 5.71289C0.787109 6.95947 1.18086 8.14394 1.92676 9.1377L6.14785 14.8228C6.1584 14.8366 6.17451 14.8418 6.18623 14.8541C6.39717 15.08 6.70156 15.0232 6.85186 14.8228C8.06738 13.2009 10.2954 10.1719 11.1521 9.0293C11.1521 9.0293 11.1523 9.02842 11.1526 9.02783L11.1579 9.0208C11.8481 8.05107 12.2129 6.90732 12.2129 5.71289C12.2129 2.56289 9.65 0 6.5 0ZM6.5 8.79492C4.804 8.79492 3.41797 7.40889 3.41797 5.71289C3.41797 4.01689 4.804 2.63086 6.5 2.63086C8.196 2.63086 9.58203 4.01689 9.58203 5.71289C9.58203 7.40889 8.196 8.79492 6.5 8.79492Z" fill="#008CE6" />
									</svg>
						...
						<div className="contacts__content__bottom__contacts__item">
							<div>
								...
								<svg width="15" height="5" viewBox="0 0 15 5" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M9.69763 0.121475L9.05389 0.765215C8.19728 1.62183 6.80342 1.62183 5.94681 0.765215L5.3031 0.121475L0.753906 4.64137C0.925791 4.7236 1.11578 4.7735 1.31872 4.7735H13.682C13.8849 4.7735 14.0749 4.7236 14.2468 4.64137L9.69763 0.121475Z" fill="white" />
								</svg>
